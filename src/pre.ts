...
export type _t4 = [] | readonly [] | [string] | readonly [string] |
...
type N4 = 0 | 1 | 2 | 3 | 4
type makeArgs<N extends N4> =
  N extends 0 ? ''
  : N extends 1 ? `x` 
  : N extends 2 ? `x y`
  : N extends 3 ? `x y z`
  : N extends 4 ? `x y z zz`
  : never 
...
type checkPreMap<
  Map extends Record<string, string>> = Map
